...
STYLE = r"""
/* Country-flag webfont. Windows' system emoji font has no flag glyphs, so flag
   emoji fall back to two-letter codes (FR, GB…). This self-hosted font (Twemoji
   flags, CC-BY 4.0 — https://twemoji.twitter.com) supplies them; the unicode-range
   scopes it to flag codepoints (regional-indicator pairs + the England/Scotland
   tag sequences) so it never touches any other text. It's listed first in the
   font stacks below because Windows' emoji font otherwise "claims" these
   codepoints and the browser never falls through to the webfont. */
@font-face{
  font-family:"Twemoji Country Flags";
  unicode-range:U+1F1E6-1F1FF,U+1F3F4,U+E0062-E007F;
  src:url("TwemojiCountryFlags.woff2") format("woff2");  /* relative to this stylesheet in /assets/ */
  font-display:swap;
}
/* ===================================================================
...
:root{
  ...
  --sans:"Twemoji Country Flags","Helvetica Neue",Helvetica,"Inter",Arial,system-ui,-apple-system,sans-serif;
  --mono:"Twemoji Country Flags",ui-monospace,"SF Mono",Menlo,Consolas,"Roboto Mono",monospace;
