...
STYLE = r"""
:root{
  --bg:#070d0c;--panel:rgba(15,26,24,.58);--panel2:rgba(23,38,34,.6);
  --line:rgba(255,255,255,.13);--hair:rgba(255,255,255,.06);
  ...
  /* depth system: lit top edge + layered elevation shadows */
  --hi:inset 0 1px 0 rgba(255,255,255,.14);
  --blur:saturate(150%) blur(22px);
  --e1:0 1px 2px rgba(0,0,0,.5),0 4px 10px -3px rgba(0,0,0,.45);
  --e2:0 4px 10px -2px rgba(0,0,0,.5),0 16px 34px -10px rgba(0,0,0,.6);
  --e3:0 10px 26px -6px rgba(0,0,0,.55),0 34px 70px -16px rgba(0,0,0,.72);
  --maxw:1200px;--r:18px;
}
...
.bg-fx{position:fixed;inset:0;z-index:0;pointer-events:none;
  background:
    radial-gradient(40vw 40vw at 10% -8%,rgba(52,211,153,.34),transparent 60%),
    radial-gradient(36vw 36vw at 98% 6%,rgba(34,211,238,.26),transparent 60%),
    radial-gradient(46vw 46vw at 72% 110%,rgba(45,212,191,.24),transparent 60%);
  filter:saturate(1.15);animation:drift 22s ease-in-out infinite alternate}
/* vignette to deepen the field so panels read as floating layers */
.bg-fx::after{content:"";position:absolute;inset:0;
  background:radial-gradient(125vw 95vh at 50% 38%,transparent 52%,rgba(0,0,0,.6))}
...
.site-head{position:sticky;top:0;z-index:20;display:flex;align-items:center;gap:18px;
  ...
  background:linear-gradient(180deg,rgba(9,17,15,.74),rgba(9,17,15,.46));
  backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);
  border-bottom:1px solid var(--line);box-shadow:0 12px 32px -16px rgba(0,0,0,.75),var(--hi)}
...
.site-nav a.on{color:#06140f;background:var(--grad);font-weight:800;box-shadow:0 8px 22px -8px var(--glow),var(--hi)}
...
.chip{padding:8px 15px;border-radius:999px;background:var(--panel);border:1px solid var(--line);
  backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);box-shadow:var(--e1),var(--hi);font-size:.9rem}
...
/* match line */
.match{background:var(--panel);border:1px solid var(--line);border-radius:14px;padding:9px 13px;
  box-shadow:var(--e1),var(--hi);transition:.18s}
.match:hover{border-color:var(--accent);transform:translateY(-3px);box-shadow:var(--e3),0 0 0 1px var(--accent),var(--hi)}
.match.has-watched{border-color:var(--accent);box-shadow:var(--e2),0 0 0 1px var(--accent),var(--hi)}
...
.group-card:hover{transform:translateY(-4px);border-color:var(--accent);box-shadow:var(--e3),0 0 0 1px var(--accent),var(--hi)}
...
.tcard{display:flex;align-items:center;gap:8px;background:var(--panel);border:1px solid var(--line);
  border-left:4px solid var(--accent);border-radius:13px;padding:9px 11px;
  box-shadow:var(--e1),var(--hi);transition:.16s}
.tcard:hover{transform:translateY(-4px);border-color:var(--accent);box-shadow:var(--e3),var(--hi)}
.tcard.watched{box-shadow:0 0 0 1px var(--accent),var(--e2),var(--hi)}
...
.team-search:focus{outline:none;border-color:var(--accent);box-shadow:0 0 0 3px rgba(45,212,191,.18),var(--e1)}
...
.dist-bar{display:flex;height:24px;border-radius:8px;overflow:hidden;background:rgba(0,0,0,.38);
...
.dist-bar .seg{display:flex;align-items:center;justify-content:center;font-size:.66rem;font-weight:800;color:#10131c;
  min-width:0;transition:width .5s ease;box-shadow:inset 0 1px 0 rgba(255,255,255,.3),inset 0 -3px 6px rgba(0,0,0,.18)}
...
/* team hero */
.team-hero{display:flex;align-items:center;gap:22px;border-radius:24px;padding:26px 28px;color:#fff;flex-wrap:wrap;
  background:linear-gradient(120deg,var(--accent),var(--accent2));position:relative;overflow:hidden;
  border:1px solid rgba(255,255,255,.18);
  box-shadow:var(--e3),inset 0 1px 0 rgba(255,255,255,.35),inset 0 -40px 60px -30px rgba(0,0,0,.45)}
.team-hero::after{content:"";position:absolute;inset:0;background:
  radial-gradient(60% 120% at 100% 0,rgba(255,255,255,.28),transparent 60%),
...
/* group banner */
.group-banner{display:flex;align-items:center;gap:18px;border-radius:24px;padding:22px 26px;
  background:var(--grad);color:#06140f;border:1px solid rgba(255,255,255,.2);
  box-shadow:var(--e3),inset 0 1px 0 rgba(255,255,255,.4),inset 0 -40px 60px -30px rgba(0,0,0,.35)}
...
.gb-teams .team{background:rgba(0,0,0,.16);color:#06140f}
.gb-teams .team:hover{background:rgba(0,0,0,.28);color:#06140f}
.gb-tag,.gb-state{color:#06140f}

/* road / scenarios */
.scenarios{display:grid;grid-template-columns:1fr 1fr;gap:18px}
.scenario{background:var(--panel);border:1px solid var(--line);border-radius:16px;padding:16px 18px;
  backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);box-shadow:var(--e1),var(--hi)}
...
.step-no{display:inline-grid;place-items:center;min-width:34px;height:24px;padding:0 6px;border-radius:7px;
  background:var(--grad);color:#06140f;font-size:.7rem;font-weight:900;box-shadow:0 5px 12px -4px var(--glow),var(--hi)}
...
.km{background:var(--panel);border:1px solid var(--line);border-radius:13px;padding:8px 10px;margin-bottom:10px;
  box-shadow:var(--e1),var(--hi);transition:.16s}
.km:hover{border-color:var(--accent);transform:translateY(-3px);box-shadow:var(--e3),0 0 0 1px var(--accent),var(--hi)}
.km.has-watched{border-color:var(--accent);box-shadow:var(--e2),0 0 0 1px var(--accent),var(--hi)}
