...
TRANSLATE_SYSTEM = (
    ...
    "ROUND NAMES — translate EXACTLY per this glossary and NEVER confuse two rounds "
    "(the site's own bracket uses these same pt-BR labels, so they must match):\n"
    "- \"Round of 32\" (the first knockout round, 32 teams) → \"Rodada de 32\". This is "
    "NOT \"oitavas de final\". \"oitavas de final\" is the Round of 16 ONLY — never use "
    "it for a Round of 32 tie. Descriptive names for this stage (\"the first knockout "
    "hurdle\", \"the last 32\") translate naturally as \"a primeira fase do mata-mata\", "
    "never as \"oitavas\".\n"
    "- \"Round of 16\" / \"the last 16\" / \"last sixteen\" → \"oitavas de final\".\n"
    "- \"Quarter-final\" / \"quarterfinal\" / \"the last eight\" → \"quartas de final\".\n"
    "- \"Semi-final\" / \"semifinal\" → \"semifinal\".\n"
    "- \"Match for third place\" / third-place playoff → \"disputa de terceiro lugar\".\n"
    "- \"Final\" → \"final\" (a decisão / a grande final are fine variants).\n\n"
    "KICKOFF TIMES — keep every date and clock time EXACTLY as the English states it. "
    "Do NOT convert to Brasília / BRT time and do NOT change any number. Keep the clock "
    "time and its timezone label verbatim: \"18:00 PT\" stays \"18:00 PT\" (never \"18h\", "
    "never \"horário do Pacífico\", never a shifted hour). You MAY translate the weekday "
    "and month, e.g. \"Sat Jul 11 18:00 PT\" → \"sábado, 11 de julho, às 18:00 PT\" and "
    "\"Thu Jul 9 13:00 PT\" → \"quinta-feira, 9 de julho, às 13:00 PT\".\n\n"
    "FOOTBALL VOCABULARY (Brazilian sports register):\n"
    "- fase de grupos, mata-mata, classificação, empate, goleada, virada, prorrogação, "
    "saldo de gols, zagueiro, meio-campo, atacante, técnico, seleção, artilheiro.\n"
    "- stoppage time / injury time / added time → \"acréscimos\" (NEVER \"paralisação\").\n"
    "- penalty shootout → \"disputa de pênaltis\"; \"won 4-3 on penalties\" → \"venceu "
    "por 4 a 3 nos pênaltis\". \"pênalti\" is MASCULINE: \"um pênalti\", \"o pênalti\", "
    "\"um pênalti nos acréscimos\" — never \"uma pênalti\".\n"
    "- Render EVERY football term in Portuguese; leave NO English word in the text. "
    "e.g. \"finishing\" → \"faro de gol\" / \"capacidade de finalização\"; \"the slow "
    "fade / long goodbye\" → \"o lento declínio / o longo adeus\". No stray \"round\", "
    "\"fade\", \"finishing\", \"shootout\", etc.\n\n"
    "OTHER RULES:\n"
    ...
    "USA / United States→Estados Unidos, Cape Verde→Cabo Verde, and so on). Group "
    "letters: \"Group J\" → \"Grupo J\".\n"
